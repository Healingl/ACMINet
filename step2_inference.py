...
config_list = [ './ckpt/20230101_fold0_ACMINet_DiceCELoss/20230101_fold0_ACMINet_DiceCELoss.yaml',
                './ckpt/20230101_fold1_ACMINet_DiceCELoss/20230101_fold1_ACMINet_DiceCELoss.yaml',
                './ckpt/20230101_fold2_ACMINet_DiceCELoss/20230101_fold2_ACMINet_DiceCELoss.yaml',
                './ckpt/20230101_fold3_ACMINet_DiceCELoss/20230101_fold3_ACMINet_DiceCELoss.yaml',
                './ckpt/20230101_fold4_ACMINet_DiceCELoss/20230101_fold4_ACMINet_DiceCELoss.yaml']
...
def main(args):
    ...
    for config in config_list:
        ...
        ckpt = config_file.with_name("model_best_loss.pth.tar")
...
def generate_segmentations(data_loaders, models, normalisations, args):
    ...
    for i, (batch_minmax, batch_zscore) in enumerate(zip(data_loaders[0], data_loaders[1])):
        ...
        # padding to full of view (Make it divisible by 16)
